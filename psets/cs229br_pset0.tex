...
\medskip
If you have questions on the homework, feel free to email all of us (Boaz+Gustaf+Gal).
...
\end{equation*}
\textbf{Hint.} See \href{https://www.stat.berkeley.edu/~mjwain/stat210b/Chap2_TailBounds_Jan22_2015.pdf}{link}.  We will also accept solutions that are \textit{poly-log}$(n)$ loose in the bound above. 
\end{subquestion}
...
\begin{equation*}
    E[\nabla_w L_{(x_t, y_t)}(f_{w_t})] = c(w_t - w_*)
\end{equation*}
