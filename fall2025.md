...
<div class="archive-callout">
  <strong>Fall 2025 archive.</strong>
  For the current course, visit the <a href="{{ '/' | relative_url }}">Fall 2026 homepage</a>.
</div>
...
<a href="{{ '/assets/q_report.pdf' | relative_url }}" style="color:#0066cc;">Course evaluations</a>

__Previous versions:__ <a href="{{ '/spring2023' | relative_url }}">Spring 2023 ML Theory Seminar</a> | [Spring 2021 ML Theory Seminar](https://boazbk.github.io/mltheoryseminar/cs229br)
